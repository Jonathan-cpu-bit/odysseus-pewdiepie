...
echo "2/3 Fixing tauri.conf.json (Silent Boot & Monochrome Icon)..."
...
echo "3/3 Fixing main.rs (Dock Accessory Mode & Native Shortcuts)..."
...
echo "All files fixed! Now running the build..."
